...
public class GeneroController {
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Requisição inválida, por exemplo, id do gênero não é um número positivo", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "Gênero não encontrado para o id fornecido", content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    @GetMapping("{id}")
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Requisição inválida, por exemplo, nome do gênero ausente ou inválido", content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    @PostMapping
    ...
    @ApiResponses({
            ...
            @ApiResponse(responseCode = "400", description = "Requisição inválida, por exemplo, id do gênero não é um número positivo ou nome do gênero inválido", content = @Content(schema = @Schema(implementation = ApiResponse.class))),
            @ApiResponse(responseCode = "404", description = "Gênero não encontrado para o id fornecido", content = @Content(schema = @Schema(implementation = ApiResponse.class)))
    })
    @PutMapping("{id}")
